...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title"> Suhas Venkata
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__description">
                Hello friends, My name is Suhas Venkata a Junior in PES University, Bangalore, I guess you have reached my portfolio, please feel free to look around
            </p>

            <a href="https://www.linkedin.com/in/suhas-venkata-b78750348/" rel="noreferrer" target = "_blank" className="button button--flex">
                Say Hello
                <svg
