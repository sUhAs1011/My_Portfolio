...
<div style="display: flex; justify-content: space-between; align-items: center;">
  ...
  <div style="font-size:16px; font-weight:bold; text-align:right;">March 2025</div>
</div>
<p style="margin-top:-10px; margin-bottom:10px;">
  Top 10 out of 50+ teams in Heal‑O‑Code Hackathon. Built a healthcare decision support tool using 
  <b>Multi‑Chain Blockchain</b> and <b>Ollama</b> for better drug recommendation.
</p>
""", unsafe_allow_html=True)
...
<div style="display: flex; justify-content: space-between; align-items: center;">
  ...
  <div style="font-size:16px; font-weight:bold; text-align:right;">March 2023</div>
</div>
<p style="margin-top:-10px; margin-bottom:10px;">
  Awarded the prestigious <b>MRD Scholarship</b> by PES University (Semester 1), receiving 20% tuition reimbursement for academic excellence.
</p>
""", unsafe_allow_html=True)
...
<div style="display: flex; justify-content: space-between; align-items: center;">
  ...
  <div style="font-size:16px; font-weight:bold; text-align:right;">February 2025</div>
</div>
<p style="margin-top:-10px; margin-bottom:10px;">
