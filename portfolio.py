...
with col_left:
    st.markdown(
        "<h3><a href='https://github.com/sUhAs1011/UE22CS342B-NLP_Mini_Project-' target='_blank' style='text-decoration: none; color: white;'>⚖️ LegalBot: AI-Powered Regulatory Mining Intelligence Bot </a></h3>",
        unsafe_allow_html=True
    )
    st.write("""
    ...
    st.markdown(
        ...
        <h3>
            ...
            <a href='https://github.com/sUhAs1011/AI-Powered-Skill-Gap-Analysis-Reskilling-for-Employment-Trends' 
               target='_blank' style='text-decoration: none; color: white;'>
               AI-Powered Skill Gap Analysis and Reskilling for Employment Trends
            </a>
        </h3>
        """,
        unsafe_allow_html=True
...
st.markdown("""
    ...
    <div style='text-align: center; padding-top: 10px; font-size: 20px; font-weight: 500; color: #ffffff;'>
